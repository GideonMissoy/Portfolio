...
function About() {
  return (
    <div className='mx-11 mt-7 text-white'>
      ...
      <div className='flex mx-9'>
        <div className='lg:w-2/5 ssm:w-fit mr-9'>
          ...
          <div className='flex mt-7'>
            <div className='lg:w-1/2 ssm:w-1/2 p-9 rounded-3xl bg-gray-950 hover:border border-green-500 mr-5'>
              <h1 className='text-5xl'>
                <span className='text-green-500'>05+</span>
              </h1>
              <p className='text-white'>PROJECTS COMPLETED</p>
            </div>
            <div className='lg:w-1/2 ssm:w-1/2 p-9 rounded-3xl bg-gray-950 hover:border border-green-500'>
              <h1 className='text-5xl'>
          ...
          <div className='flex justify-center mt-7'>
            <h1 className='flex justify-center items-center pl-6 py-2 border border-green-500 rounded-full'>
              <span className='font-bold pr-2'>DOWNLOAD MY CV</span>
              <MdDownloadForOffline size={35} />
            </h1>
          </div>
        </div>
        <div className='lg:w-3/5 ssm:w-fit'>
          <p>
            ...
            <br />I bring a unique blend of technical expertise and creative
            vision to web development. I am dedicated to delivering cutting-edge
            digital experiences and thrive on continuous growth and learning
            through new challenges. Passionate about applying new technologies
            to real-world issues, I find great fulfillment in diverse projects
            that showcase my creativity and problem-solving abilities. Motivated
            to contribute to organizational growth and industry advancement, I
            am committed to making meaningful contributions and pushing the
